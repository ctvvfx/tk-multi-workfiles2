...
"}")
        ...
        self.file_controls_grid.addWidget(self.name_label,1,0,1,1)

        self.name_h_layout = QtGui.QHBoxLayout()
        ...
        self.name_h_layout.addStretch()
        self.file_controls_grid.addLayout(self.name_h_layout, 1, 1, 1, 1)

        self.stream_label = QtGui.QLabel(FileSaveForm)
        self.stream_label.setMinimumSize(QtCore.QSize(0, 0))
        self.stream_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.stream_label.setIndent(-1)
        self.stream_label.setObjectName("stream_label")
        self.file_controls_grid.addWidget(self.stream_label,2,0,1,1)

        self.stream_h_layout = QtGui.QHBoxLayout()
        self.stream_edit = QtGui.QLineEdit(FileSaveForm)
        self.stream_edit.setMaximumSize(QtCore.QSize(200, 16777215))
        self.stream_edit.setFrame(True)
        self.stream_edit.setObjectName("stream_edit")
        self.stream_h_layout.addWidget(self.stream_edit)
        self.stream_h_layout.addStretch()
        self.file_controls_grid.addLayout(self.stream_h_layout, 2, 1, 1, 1)
        ...
        self.file_controls_grid.addWidget(self.version_label, 3, 0, 1, 1)
        ...
        self.file_controls_grid.addLayout(self.horizontalLayout_2, 3, 1, 1, 1)
        ...
        self.file_controls_grid.addWidget(self.file_type_label, 4, 0, 1, 1)
        ...
        self.file_controls_grid.addLayout(self.horizontalLayout_6, 4, 1, 1, 1)
    ...
    def retranslateUi(self, FileSaveForm):
        ...
        self.stream_label.setText(QtGui.QApplication.translate("FileSaveForm", "<html><head/><body><p><span style=\" font-weight:600;\">Stream:</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
